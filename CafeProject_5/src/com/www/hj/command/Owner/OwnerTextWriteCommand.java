...
public class OwnerTextWriteCommand implements Command {
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(Hours); //주석
		System.out.println(request.getParameter("hashtag")); //주석
		...
		writeDTO.setCafeIntroduce("cafeIntroduce");
		writeDTO.setCafeHashTag(request.getParameter("hashtag"));
		
		
		
		
		session.setAttribute("writeDTO", writeDTO);
	}
}