  ...
  <main>
        <form  name="CosFrom" action="OwnerText.do">
            <h2 id="cafeInfo">카페 정보</h2>
                카페 이름: <input type="text" name="cafeName" class="cafeInfo" id="cafeName" placeholder=' 카페 이름 (필수)' required><br/>
                전화 번호: <input type="text" name="cafeNumber" class="cafeInfo" id="cafeNumber" placeholder=' 전화 번호' ><br/>
                대표 메뉴: <input type="text" name="cafeMenu" class="cafeInfo" id="cafeMenu" placeholder=' 대표 메뉴 (필수)' required><br/>
                ...
                <br/>
                한줄 카페 소개: <input type="text" name="cafeIntroduce" class="cafeInfo" id="cafeIntroduce" placeholder=' 카페 한줄 소개 (필수) (15자 최대)' maxlength="15" required>
                <br/>
                
                 위치: <input type="text" name="cafeAddress" id="sample5_address"  class="cafeInfo" placeholder=' 위치 (필수)' required>
