...
public class OwnerTextWriteCommand implements Command {
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		writeDTO.setStamp5(request.getParameter("stamp5"));
		writeDTO.setStamp10(request.getParameter("stamp10"));
		writeDTO.setStamp15(request.getParameter("stamp15"));
		writeDTO.setStamp20(request.getParameter("stamp20"));
