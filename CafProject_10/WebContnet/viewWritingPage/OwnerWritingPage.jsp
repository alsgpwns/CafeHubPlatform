...
<%@ include file="/IncludeFile/LoginOkOwnerHeader.jsp" %>
    <main>
     	...
     	<c:if test="${empty wishCheck }">
     		<div id="wishBox">
     			<a href="iLikeIt.do?likeType=owner&likeId=${showDTO.id }" id="heart" style="color:gray;"><i class="fas fa-heart"></i></a>
		...
		<c:if test="${not empty wishCheck }">
			<div id="wishBox">
     			<a href="iLikeIt.do?likeType=owner&likeId=${showDTO.id }" id="heart" style="color: rgb(191, 162, 218);" ><i class="fas fa-heart"></i></a>
     			<h5 id="wishDesc">가고싶다</h5>
     		</div>
		</c:if>
